  ...
  <main class="content">
    ...
    <form>
      <div class="input-field">
        ...
        <input type="text" id="sku" class="input-text" value="456"/> 
      </div>
      <div class="input-field">
        <label for="name" class="label">Product Name</label>
        <input type="text" id="name" class="input-text" value="Ombro"/> 
      </div>
      <div class="input-field">
        <label for="price" class="label">Price</label>
        <input type="text" id="price" class="input-text" value="35"/> 
      </div>
      <div class="input-field">
        <label for="quantity" class="label">Quantity</label>
        <input type="text" id="quantity" class="input-text" value="10"/> 
      </div>
      <div class="input-field">
      ...
      <div class="input-field">
        ...
        <textarea id="description" class="input-text">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
        </textarea>
      </div>
      <div class="actions-form">
        <a href="index.html" class="action back">Back</a>
 ...
 <script>
   $(document).ready(function() {
    ...
    $('form').submit(function() {
      ...
      console.log('chama salva e mostra loading');

      const name = $('#name').val();
      const sku = $('#sku').val();
      const price = $('#price').val();
      const desc = $('#description').val();
      const qtd = $('#quantity').val();
      const categories = $('#category').val();

      const request = $.ajax({
			  url: "php_actions/add_product.php",
			  method: "POST",
        data: {
         name: name,
         sku: sku,
